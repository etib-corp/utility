...
Utility uses [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/)
...
- `feat(math): add new vector helpers`
- `fix(graphic): prevent crash on startup`
- `docs: update installation instructions`
- `refactor(event): simplify dispatch`
